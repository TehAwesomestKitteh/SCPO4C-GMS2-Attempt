...
Details_string = "Development Build";
Large_text = "SCP: O4 Command";
...
rousr_dissonance_set_large_image("o4cart_default", Large_text);  // set images from your app dashboard here
